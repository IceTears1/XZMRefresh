...
NSString *const XZMRefreshFooterRefreshing = @"正\n在\n刷\n新\n数\n据\n中\n.\n.\n.";
NSString *const XZMRefreshFooterPullToRefresh = @"滑\n动\n可\n以\n刷\n新";
NSString *const XZMRefreshFooterReleaseToRefresh = @"右\n拉\n可\n以\n刷\n新";
NSString *const XZMRefreshHeaderPullToRefresh = @"右\n拉\n可\n以\n刷\n新";
NSString *const XZMRefreshHeaderReleaseToRefresh = @"松\n开\n立\n即\n刷\n新";
NSString *const XZMRefreshHeaderRefreshing = @"正\n在\n刷\n新\n数\n据\n中\n.\n.\n.";
